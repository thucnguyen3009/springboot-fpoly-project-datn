...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/DTNsBike/checkout.html";
    public static String vnp_TmnCode = "YNDVVAJD";
    public static String vnp_HashSecret = "UUINYKCZCVHLYAMVFNEUEBEWJHLARWBK";
